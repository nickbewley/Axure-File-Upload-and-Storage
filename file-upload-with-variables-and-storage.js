...
// ------------ ADDING DATA STORAGE ------------
// this verifies that Parse has loaded before executing the upload function. Otherwise the "Parse" variable may not be available
function checkParse(callback){
    ...
    script.src = 'http://www.parsecdn.com/js/parse-1.2.15.min.js';
